...
public class QuartzProperties {
    ...
    public QuartzProperties setLocal(Boolean local) {
        isLocal = local;
        return this;
    }

    public List<String> getJobScan() {
        return jobScan;
    }

    public QuartzProperties setJobScan(List<String> jobScan) {
